...
class ExcelReporter:
    ...
    _CONTRACT_COLS = [
        ...
        ("Moneyness",      10), ("Delta",      7), ("Expiration", 12),
        ("DTE",             6), ("Bid",        8), ("Ask",        8),
        ("Volume",         10), ("Open Interest", 14), ("Vol/OI",  9),
        ("Premium ($)",    14), ("IV",         8), ("Underlying $", 12),
        ("Trade Time",     18), ("Symbol",     28),
    ]
    ...
    def _write_contracts_sheet(self, wb, name, contracts):
        ...
        for c in contracts:
            ws.append([
                ...
                c.moneyness, round(c.delta, 3), c.expiration_label,
                c.dte, c.bid, c.ask,
    ...
    _BETS_COLS = [
        ...
        ("Total Premium ($)", 16), ("Call Volume", 12), ("Put Volume",     12),
        ...
        ("Top Premium ($)", 14), ("Top Vol/OI", 10), ("Top IV",        8),
    ]
